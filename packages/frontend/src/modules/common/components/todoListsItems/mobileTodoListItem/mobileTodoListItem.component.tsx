...
import * as Styled from './mobileTodoListItem.styled';
...
const MobileTodoListItem = ({ description, id, isCompleted, title, personal }: TodoType) => {
...
export default MobileTodoListItem;
